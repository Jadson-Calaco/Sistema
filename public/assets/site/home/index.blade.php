...
<div id="home">
    ...
    <div id="da-slider" class="da-slider">
        ...
        <div class="container">
            <!-- Start first slide -->
            <div class="da-slide">
                <h2 class="fittext2">Bem-vindo ao Meta Educa</h2>
                <!--h4>Clean & responsive</h4-->
                <p>A Meta Educa é uma plataforma digital com questões de todas as disciplinas. A ideia é ajudar os professores na preparação de suas provas e ajudar os alunos a estudar para as mesmas  . 
                    A ferramenta reúne  mais de 125.000 questões.</p>
                <a href="#" class="da-link button">Consulte Mais informação</a>
                <div class="da-img">
                    <img src="assets/layout/images/Slider01.png" alt="image01" width="320">
                </div>
            </div>
            <!-- End first slide -->
            <!-- Start second slide -->
            <div class="da-slide">
                <h2>Meta Educa</h2>
                <!--h4>Customizable</h4-->
                <p>Acessar o site do Meta Educa através do seu computador e usufrua dos benefícios dessa plataforma.</p>
                <a href="#" class="da-link button">Consulte Mais informação</a>
                <div class="da-img">
                    <img src="assets/layout/images/Slider03.png" width="320" alt="image03">
                </div>
            </div>
            <!-- End second slide -->
            <!-- Start third slide -->
            <div class="da-slide">
                <h2>Meta Educa</h2>
                <!--h4>Easy to use</h4-->
                <p>Você pode acessar o site do Meta Educa através do navegador do seu celular e usufruir dos mesmos benefícios.</p>
                <a href="#" class="da-link button">Consulte Mais informação</a>
                <div class="da-img">
                    <img src="assets/layout/images/Slide2.png" width="320" alt="image02">
                </div>
            </div>
            <!-- Start third slide -->
    ...
    <div class="container">
        ...
        <div class="row-fluid">
            <div class="span4">
                <div class="centered service">
                    <div class="circle-border zoom-in">
                        <img class="img-circle" src="assets/layout/images/escola.png" alt="service 1">
                    </div>
                    <h3>Escola</h3>
            ...
            <div class="span4">
                <div class="centered service">
                    <div class="circle-border zoom-in">
                        <img class="img-circle" src="assets/layout/images/img5.png" alt="service 2" />
                    </div>
                    <h3>Professor</h3>
                    <p>Gere provas e simulados em poucos minutos. Recurso anticola, gabarito
                        e muito mais!</p>
                </div>
            </div>
            <div class="span4">
                <div class="centered service">
                    <div class="circle-border zoom-in">
                        <img class="img-circle" src="assets/layout/images/img4.png" alt="service 3">
                    </div>
                    <h3>Aluno</h3>
                    <p>Acesse simulados e lista de exercícios, consulte seus resultados por meio
    ...
    <div class="container">
        ...
        <div class="price-table row-fluid">
            <div class="span3 price-column">
                <h3>Basic</h3>
                <ul class="list">
                    <li class="huge"><strong>100</strong> Questões</li>
                    <li><strong>1</strong> Mês</li>
                    <li>R$ 49,99</li> 
                </ul>
                <a href="cadastro?id=1" class="button button-ps">Comprar</a>
            </div>
            <div class="span3 price-column">
                <h3>Pro</h3>
                <ul class="list">
                    <li class="huge"><strong>300</strong> Questões</li>
                    <li><strong>3</strong> Meses</li>
                    <li>R$ 139,99</li> 
                </ul>
                <a href="cadastro?id=2" class="button button-ps">Comprar</a>
            </div>
            <div class="span3 price-column">
                <h3>Premium</h3>
                <ul class="list">
                    <li class="huge"><strong>600</strong> Questões</li>
                    <li><strong>6</strong> Meses</li>
                    <li>R$  259,99</li> 
                </ul>
                <a href="cadastro?id=3" class="button button-ps">Comprar</a>
            </div>
            <div class="span3 price-column">
                <h3>Gold</h3>
                <ul class="list">
                    <li class="huge"><strong>1200</strong> Questões</li>
                    <li><strong>1</strong> Ano</li>
                    <li>R$  499,99</li> 
                </ul>
                <a href="cadastro?id=4" class="button button-ps">Comprar</a>
            </div>
        </div>
        <div class="centered">
...
<div class="section primary-section" id="about">
    ...
    <div class="container">
        <div class="title">
            <h1>Sobre</h1>
            <p>Bem vindo, aqui você encontra mais informação sobre nossa empresa.</p>
        </div>
